...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-cyan-600 via-sky-400 to-cyan-600 text-white">
      ...
      <div className="relative max-w-7xl mx-auto min-h-screen px-4 sm:px-6 lg:px-8 flex items-center justify-center py-16 sm:py-20">
        <div className="text-center w-full z-10">
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white to-cyan-200 bg-clip-text ">
            Hai, Aku Ayana Izumi!
          </h1>
          <p className="text-lg sm:text-xl lg:text-2xl mb-6 sm:mb-8 text-cyan-100 max-w-3xl mx-auto px-4">
            Teman AI Paling Gemes di WhatsApp! Bikin Chat-mu Makin Seru & Berwarna!
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
            <a
              href="#features"
              className="w-full sm:w-auto bg-white text-cyan-600 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:bg-cyan-50 transition-colors text-base sm:text-lg"
            >
              Jelajahi Fitur Ayana
            </a>
            <a
              href="#social"
              className="w-full sm:w-auto border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:bg-white hover:text-cyan-600 transition-colors text-base sm:text-lg"
            >
              Chat Sekarang!
            </a>
          </div>
